        ...
        child: RefreshIndicator(
          ...
          child: ListView(
            ...
            children: [
              ...
              // 3. Shop Owner Action: Register Physical Retail Store (Green Gradient / Crisp Card)
              Material(
                color: Colors.transparent,
                borderRadius: BorderRadius.circular(20),
                child: InkWell(
                  onTap: () => context.push('/shop/onboarding'),
                  borderRadius: BorderRadius.circular(20),
                  child: Container(
                    decoration: BoxDecoration(
                      color: Colors.white,
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: const [
                              ...
                              SizedBox(height: 3),
                              Text(
                                'Own a retail store? Create your shop & reach nearby shoppers.',
                                style: TextStyle(
                                  fontSize: 12.5,
                                  fontWeight: FontWeight.w400,
                                  color: Color(0xFF64748B),
                        ...
                        Container(
                          ...
                          child: const Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              Icon(Icons.add_business_rounded, size: 14, color: Color(0xFF059669)),
                              SizedBox(width: 4),
                              Text(
                                'Create Shop',
                                style: TextStyle(
              ...
              Center(
                child: Row(
                  ...
                  children: [
                    Text(
                      'Signed in as ${authState.user?.email ?? "User"}',
